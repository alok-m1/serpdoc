...
<Callout type="info">
  Yahoo requires regional domains → use <code>serphouse_domain_list</code> or
  browse the [Domains List](/extra-apis/domains-list) to find the right domain
  for your target region. <code>yahoo.com</code> is not valid.
</Callout>

<VisualRef
  title="Yahoo Search API"
  src="/images/yahoo/yahoo-search-api.png"
  alt="Yahoo web search results"
/>
