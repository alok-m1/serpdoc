...
import {
  yahooNewsJsonResponse,
  yahooNewsMarkdownResponse,
  yahooNewsHtmlResponse,
} from "@/lib/api-examples/yahooNews";
...
<Callout type="info" title="Response format">
  ...
  - **JSON** (default) — `https://api.serphouse.com/yahoo-news`
  - **Markdown** — `https://api.serphouse.com/yahoo-news/md`
  - **HTML** — `https://api.serphouse.com/yahoo-news/html`
</Callout>
...
<ApiExample mode="response">
  <ApiTab label="JSON" response={yahooNewsJsonResponse} />
  <ApiTab label="HTML" response={yahooNewsHtmlResponse} lang="html" />
  <ApiTab
    label="Markdown"
    response={yahooNewsMarkdownResponse}
    lang="markdown"
  />
</ApiExample>
