...
<Steps>
  ...
  <Step>
    Keep it handy — you'll add it to OpenClaw next.
  </Step>
</Steps>
...
<Steps>
  <Step>
    Run the doctor probe above.
  </Step>
  <Step>
    Confirm <code>serphouse</code> reports <code>connected</code> and the tool list is non-empty.
  </Step>
  <Step>
...
<Tabs items={['Rank Tracking', 'News & Media', 'Local SEO', 'Media Search', 'Multi-Engine']}>
  ...
  <Tab value="News & Media">
    ...
    - `What is Yahoo News covering about "electric vehicles" right now?`
  </Tab>

  <Tab value="Local SEO">
    - `Top Google Local results for "emergency plumber" in Chicago.`
    - `Find the best-rated coffee shops near "Austin, Texas".`
  </Tab>

  <Tab value="Media Search">
    - `Search Bing Images for "minimalist desk setup".`
    - `Show me Google Videos for "WebAssembly tutorial".`
  </Tab>
...
<Callout type="info" title="Still stuck?">
  Re-verify your API key, credit balance, and the endpoint URL first. If it persists, contact [SERPHouse support](https://serphouse.com).
</Callout>
