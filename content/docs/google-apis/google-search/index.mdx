...
<Callout type="info">
  Returns structured JSON with search metadata, parameters, and results
  including organic listings, local pack, and inline shopping.
</Callout>

<VisualRef
  title="Google Search API"
  src="/images/google/google-search-api.png"
...
<ApiExample mode="response">
  ...
  <ApiTab
    label="Markdown"
    response={googleSearchApiMarkdownResponse}
    lang="markdown"
  />
</ApiExample>
...
<Cards>
  ...
  <Card
    ...
    href="/google-apis/google-lite-web-search-api"
  />
</Cards>
