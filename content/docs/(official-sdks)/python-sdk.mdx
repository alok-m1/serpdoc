...
<Callout type="info">
  The SDK provides access to Google SERP, Google News, and Google Short Videos
  directly through a simple typed client.
</Callout>

<ResourceCards>
  <ResourceCard
    title="GitHub"
    subtitle="SERPHouse/ai-sdk-python"
    href="https://github.com/SERPHouse/ai-sdk-python"
    icon="github"
  />
  <ResourceCard
    title="PyPI"
    subtitle="serphouse-ai-sdk"
    href="https://pypi.org/project/serphouse-ai-sdk/"
    icon="pypi"
  />
</ResourceCards>
...
<Callout type="idea" title="Always handle errors">
  ...
  fail. Always wrap calls in try-catch.
</Callout>
