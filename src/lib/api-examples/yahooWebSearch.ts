...
export const yahooWebSearchHtmlResponse = `<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Yahoo Web Search API — Example Response</title>
  <style>
...
.result p { margin: 0; font-size: 14px; color: #334155; }
...
<body>
  <header class="topbar">
    <div class="brand"><span class="dot"></span> SERPHouse <span class="sep">/</span> Yahoo Web Search API</div>
    <div class="badge">example response</div>
  </header>
  <main class="wrap">
    <section class="hero">
      <h1>Donald Trump</h1>
      <p class="meta">About 0 results &nbsp;·&nbsp; fr.yahoo.com &nbsp;·&nbsp; lang_en</p>
    </section>
    <section class="card">
      ...
      <ol class="results">
        <li class="result">
          ...
          <div>
            <div class="site">www.01net.com · hebergeur · cloud</div>
            <a class="title" href="https://www.01net.com/hebergeur/cloud/">Meilleur hébergement Cloud en 2026 : le comparatif de 01net</a>
            <p>30 mars 2026 · Quel hébergeur propose le meilleur hébergement Cloud ? Découvrez l'avis d'experts au sujet des meilleurs Cloud en 2026.</p>
          </div>
        </li>
        <li class="result">
          <span class="rank">02</span>
          <div>
            <div class="site">fr.hostadvice.com · cloud-hosting</div>
            <a class="title" href="https://fr.hostadvice.com/cloud-hosting/">Meilleur Hébergement Cloud : 12 Fournisseurs évolutifs (2026)</a>
            <p>Il y a 6 jours · Cloud Hosting est une solution d’hébergement qui repose sur un réseau de serveurs virtuels tirant leurs ressources de plusieurs machines physiques...</p>
          </div>
        </li>
        <li class="result">
          <span class="rank">03</span>
          <div>
            <div class="site">www.ovhcloud.com · fr</div>
            <a class="title" href="https://www.ovhcloud.com/fr/">Cloud Computing &amp; Hébergement Web | OVHcloud France</a>
          </div>
        </li>
        <li class="result">
          <span class="rank">04</span>
          <div>
            <div class="site">www.websiteplanet.com · fr · blog</div>
            <a class="title" href="https://www.websiteplanet.com/fr/blog/les-meilleurs-services-dhebergement-cloud-en-fiables-et-abordables/">Meilleurs hébergeurs sur Cloud en 2026 – fiables et abordables</a>
            <p>28 févr. 2026 · Vous cherchez un hébergement cloud fiable ? Voici les fournisseurs d'hébergement cloud recommandés par notre expert et les fonctionnalités à rechercher.</p>
          </div>
        </li>
        <li class="result">
          <span class="rank">05</span>
          <div>
            <div class="site">www.guru99.com · fr · best-free-cloud-hosting</div>
            <a class="title" href="https://www.guru99.com/fr/best-free-cloud-hosting-services.html">4 meilleurs services d'hébergement cloud GRATUITS (2026)</a>
            <p>Tout d’abord, j’analyse les services d’hébergement cloud depuis des années et j’ai développé un sens aigu de ce qui distingue un fournisseur.</p>
          </div>
        </li>
        <li class="result">
          <span class="rank">06</span>
          <div>
            <div class="site">www.forbes.com · software · best-cloud-hosting</div>
            <a class="title" href="https://www.forbes.com/advisor/business/software/best-cloud-hosting/">10 Best Cloud Hosting Services of 2026 – Forbes Advisor</a>
            <p>We’ve dug deep into the data to identify the best cloud hosting services for small businesses, comparing plans, pricing, features and service...</p>
          </div>
        </li>
        <li class="result">
          <span class="rank">07</span>
          <div>
            <div class="site">www.pcmag.com · picks · the-best-cloud-web-hosting</div>
            <a class="title" href="https://www.pcmag.com/picks/the-best-cloud-web-hosting-services">The Best Cloud Hosting Services for 2026 - PCMag</a>
            <p>Here's everything you need to know to choose the right cloud hosting service for your website, along with our top picks.</p>
          </div>
        </li>
      </ol>
    </section>
    <section class="card">
      ...
      <h2>Videos</h2>
      <div class="videos">
        <a class="video" href="https://www.youtube.com/watch?v=Kol8ymACLU8">
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg>
          <div>
            <div class="video-title">Hosting, Cloud, Docker, Kubernetes : tout comprendre de zéro</div>
            <div class="video-meta">7 juil. 2026</div>
          </div>
        </a>
        <a class="video" href="https://www.youtube.com/watch?v=b9LhTp_4ZJA">
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg>
          <div>
            <div class="video-title">Top 10 Best Web Hosting Sites in 2026 | Reliable &amp; Affordable Hosting Services</div>
            <div class="video-meta">9 juin 2026</div>
          </div>
        </a>
        <a class="video" href="https://www.youtube.com/watch?v=i7D5aTKrFzY">
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg>
          <div>
            <div class="video-title">The Power of Cloud Hosting: A Beginner's Guide</div>
            <div class="video-meta">12 août 2025</div>
          </div>
        </a>
      </div>
    </section>
    <section class="card">
      <div class="eyebrow">sponsored results</div>
      <h2>Sponsored</h2>
      <ol class="results">
        <li class="result">
          <span class="rank">01</span>
          <div>
            <div class="site">cloud.google.com</div>
            <a class="title" href="https://ad.doubleclick.net/searchads/link/click?lid=58700009050576483">Google Cloud - Powerful Cloud Solutions</a>
            <p>Fast, highly scalable, cost effective, and fully managed cloud data warehouse. Start free. High performance infrastructure for cloud computing, data analytics and machine learning.</p>
          </div>
        </li>
        <li class="result">
          <span class="rank">02</span>
          <div>
            <div class="site">eu.siteground.com/Built for/Perfomance</div>
            <a class="title" href="https://eu.siteground.com/cloud-hosting.htm?mktafcode=4ea8d530b9b55fb307dffc28907c1a49">SiteGround® Cloud Hosting - Google Cloud Plan from $100/mo</a>
            <p>Deploy sites with built-in staging &amp; Git. Set resources dedicated to each site you manage! Fully managed cloud, isolated site infrastructure, autoupdates, guaranteed CPU, RAM &amp; SSD.</p>
          </div>
        </li>
        <li class="result">
          <span class="rank">03</span>
          <div>
            <div class="site">www.lightnode.com</div>
            <a class="title" href="https://www.lightnode.com/en-US/lightnodevsVU?DO&amp;ref=63f28b0b&amp;id=11">Global Quality Cloud Servers - LightNode Is Best - Since 2002</a>
            <p>Start your VPS 1v CPU 2GB RAM Only $7.7/Month. Hourly billing. Trusted by over 50,000 customers all over the world.</p>
          </div>
        </li>
        <li class="result">
          <span class="rank">04</span>
          <div>
            <div class="site">www.ionos.fr/serveurs/vps</div>
            <a class="title" href="https://ad.doubleclick.net/searchads/link/click?lid=58700008943458854">Économisez sur votre VPS - VPS dès 1 € HT/mois</a>
            <p>Choisissez votre VPS Linux au meilleur rapport qualité-prix chez IONOS. Hébergement VPS dès 1 € HT/mois : performance de pointe et prix avantageux.</p>
          </div>
        </li>
        <li class="result">
          <span class="rank">05</span>
          <div>
            <div class="site">contabo.com/hetzner/Alternative</div>
            <a class="title" href="https://contabo.com/en/vps/?utm_source=Microsoft_Bing&amp;utm_medium=cpc">Exploring options? Get Contabo - 20% Off 2-Year VPS Contracts</a>
            <p>Cloud hosting excellence since 2003. 24/7 expert support, 200k+ happy customers worldwide. Get full root access, unlimited bandwidth, Auto Backup. No hidden fees.</p>
          </div>
        </li>
        <li class="result">
          <span class="rank">06</span>
          <div>
            <div class="site">www.interserver.net/vps/hosting</div>
            <a class="title" href="https://www.interserver.net/vps/?utm_medium=adwords&amp;utm_campaign=_source=">Affordable Cloud VPS - VPS Hosting From $3</a>
            <p>Move from expensive cloud hosting to flexible monthly VPS hosting. Run Linux, Windows, or Storage VPS with root access and 24/7 support.</p>
          </div>
        </li>
        <li class="result">
          <span class="rank">07</span>
          <div>
            <div class="site">wix.com</div>
            <a class="title" href="https://www.wix.com/blog/what-is-cloud-hosting?utm_source=bing&amp;utm_medium=cpc">Cloud Hosting Services - Get Free Web Hosting</a>
            <p>Showcase Your Music, Events and Merch with a Website Tailored to Your Sound on Wix. Build a Professional Online Presence to Connect with Fans and Promote Your Music.</p>
          </div>
        </li>
      </ol>
    </section>
  ...
  <footer class="foot">
    Generated from the SERPHouse Yahoo Web Search API &middot; 2026-08-03T07:05:57.000000Z
  </footer>
</body>
</html>`;
