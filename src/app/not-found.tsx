...
export default function NotFound() {
  ...
  return (
    <div className="relative flex min-h-[calc(100vh-3rem)] flex-col items-center justify-center overflow-hidden px-4 py-12 sm:py-16">
      {/* ambient background */}
      ...
      <div className="relative mx-auto w-full max-w-xl">
        ...
        <div className="overflow-hidden rounded-2xl border border-fd-border bg-fd-card/60 shadow-2xl shadow-black/5 backdrop-blur-sm">
          {/* query bar */}
          <div className="flex items-center gap-3 border-b border-fd-border px-4 sm:px-5 py-4">
          ...
          <div className="px-4 sm:px-5 py-8 text-center">
            <div className="mb-1 font-mono text-5xl font-bold tracking-tight text-fd-foreground/90 sm:text-6xl md:text-7xl">
          ...
          <div className="flex items-center justify-between border-t border-fd-border bg-fd-secondary/30 px-4 sm:px-5 py-3 font-mono text-xs text-fd-muted-foreground">
